...
pipeline
{
    ...
    stages
    {
        ...
        stage('ContinousDeployment:Loans')
        {
            steps
            {
                sh label: '', script: 'scp /home/ubuntu/.jenkins/workspace/MultiBranch_Pipeline_loans/target/my-app.war ubuntu@172.31.35.155:/var/lib/tomcat8/webapps/testapp.war'
            }
        }
    }
}
